...
349: nan (see pink arrow). After that, add another line of the structure: 
...
ID 5 (see red arrow)
349: nan (see pink arrow)
332: 5 Appear (see black arrow)
...
183: Disappear in 6 (see green arrow). If later, the spot that disappeared is reappearing, just write a line with: 
